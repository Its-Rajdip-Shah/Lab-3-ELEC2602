module two_bit_4to1muxV2 (s, u, v, w, x, m); // Starts a 2-bit 4-to-1 mux module written with always blocks.
    ...
    output reg [1:0] m; // Stores the chosen 2-bit output.

    reg [1:0] t1, t2; // Holds the two middle 2-bit results before the final choice.
